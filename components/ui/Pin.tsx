...
export const PinPerspective = ({
  ...
  return (
    ...
    <motion.div className="pointer-events-none w-1/2 h-20 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
